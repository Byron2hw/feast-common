...
import com.feast.common.exception.DataAccessException;
 ...
 */
@Component
public class DataAccessExceptionCommonHandler extends AbstractExceptionCommonHandler {
    @Override
    ...
    public boolean support(Class<? extends Exception> targetClass) {
        return DataAccessException.class.isAssignableFrom(targetClass);
    }
}
